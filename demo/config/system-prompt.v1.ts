// ─── BACKUP — system prompt v1 (original) ────────────────────────────────────
// This is the original prompt before tightening for Llama compliance.
// To revert: copy the SYSTEM_PROMPT value back into system-prompt.ts.
